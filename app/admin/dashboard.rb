...
ActiveAdmin.register_page 'Dashboard' do
  ...
  content title: 'Dashboard' do
    ...
    div "Welcome to the QUL CMS Dashboard! This content management system provides tools to browse, validate, and manage Quranic data. It also allows authorized users to run reports and moderate content updates efficiently. #{readonly_msg}", class: 'p-4 mb-4 bg-blue-50 border border-blue-200 text-blue-800 rounded'
    ...
    columns do
      column do
        panel 'Tajweed rules' do
          div "This section includes tools to find words with a specific tajweed rule", class: 'p-4 mb-4 bg-blue-50 border border-blue-200 text-blue-800 rounded'
