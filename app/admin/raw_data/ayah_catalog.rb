  ...
  content do
    ...
    if verse
      ...
      catalog.each do |content|
        panel "<div data-bs-toggle='collapse' data-bs-target='#content-#{content.id}' class='flex collapable scrollable'>#{content.resource&.name} <span class='ms-auto'></span></div>".html_safe do
          div do
