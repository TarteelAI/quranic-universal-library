Rails.application.routes.draw do
  ...
  resource :ayah_timestamp_verification, only: [:show, :create],
           controller: 'ayah_timestamp_verifications',
           path: 'ayah-timestamp-verification'
  ...
  resources :surah_infos, except: :destroy
