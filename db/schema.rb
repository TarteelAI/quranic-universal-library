...
ActiveRecord::Schema[8.0].define(version: 2026_01_19_002000) do
  ...
  create_table "quran_script_by_verses", force: :cascade do |t|
    t.string "text"
    t.integer "qirat_id"
    t.integer "resource_content_id"
    t.string "key"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["key"], name: "index_quran_script_by_verses_on_key"
    t.index ["qirat_id"], name: "index_quran_script_by_verses_on_qirat_id"
    t.index ["resource_content_id"], name: "index_quran_script_by_verses_on_resource_content_id"
    t.index ["text"], name: "index_quran_script_by_verses_on_text"
    t.index ["verse_id"], name: "index_quran_script_by_verses_on_verse_id"
  end

  create_table "quran_script_by_words", force: :cascade do |t|
    t.string "text"
    t.string "qirat_id"
    t.string "resource_content_id"
    t.string "key"
    t.string "word_id"
    t.string "verse_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["key"], name: "index_quran_script_by_words_on_key"
    t.index ["qirat_id"], name: "index_quran_script_by_words_on_qirat_id"
    t.index ["resource_content_id"], name: "index_quran_script_by_words_on_resource_content_id"
    t.index ["text"], name: "index_quran_script_by_words_on_text"
    t.index ["verse_id"], name: "index_quran_script_by_words_on_verse_id"
    t.index ["word_id"], name: "index_quran_script_by_words_on_word_id"
  end
  ...
  create_table "raw_data_ayah_records", force: :cascade do |t|
    ...
    t.integer "raw_resource_id"
    t.string "content_css_class"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["raw_resource_id"], name: "index_raw_data_ayah_records_on_raw_resource_id"
