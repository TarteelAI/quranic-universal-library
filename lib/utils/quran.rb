...
module Utils
  class Quran
    ...
    def self.get_muhsaf_page(ayah_id)
      page = 0
      page += 1 while MUSHAF_PAGES[page] && ayah_id >= MUSHAF_PAGES[page]
